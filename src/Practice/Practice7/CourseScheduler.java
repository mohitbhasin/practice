...
class CourseScheduler {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(cs.topologySort(numCourses, prerequisites));
    }

    // Topology Sort the data.
    public boolean topologySort(int numCourses, int[][] prerequisites) {
    ...
    public boolean dfs(int course) {
        if(!prereqMap.containsKey(course) || valid[course]) {
            return true;
        }
